...
angular.module('enplug.sdk.utils.templates', []).run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put("sdk-utils/theme-picker.tpl",
        "<div class=themes-directive><div class=themes-flexbox><h3 class=flexbox-header><translate>Enplug Themes</translate></h3><div class=enplug-themes-container><div ng-class=\"{'selected': selectedTheme.Id == theme.Id}\" ng-style=filterStyle(theme) ng-click=selectTheme(theme) ng-repeat=\"theme in enplugThemes | orderDefaultTheme: enplugThemes\" class=custom-themes><div class=template><div class=mini-template ng-style=filterStyle(theme) ng-transclude></div></div><span class=label>{{theme.Name}}</span><div ng-hide=false class=roll-over><button class=\"btn theme-edit-button theme-copy-button\" ng-click=\"\n" +
