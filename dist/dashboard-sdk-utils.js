...
angular.module('enplug.sdk.utils.templates', []).run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put("sdk-utils/help-block.tpl",
        "<footer class=\"footer-help block-center\"><div class=\"info-message text-gray\"><i class=\"ion-help-circled text-primary\"></i><translate>Need help? Go to the</translate>&nbsp;<a ng-href=\"{{ supportUrl || 'http://support.enplug.com/hc/en-us' }}\" target=_blank><translate>Help Center</translate></a></div></footer>");
    ...
    $templateCache.put("sdk-utils/theme-picker.tpl",
        "<div class=themes-directive><div class=themes-flexbox><h3 class=flexbox-header><translate>Default Themes</translate></h3><div class=enplug-themes-container><div ng-class=\"{'selected': selectedTheme.Id == theme.Id}\" ng-style=filterStyle(theme) ng-click=selectTheme(theme) ng-repeat=\"theme in defaultThemes | orderDefaultTheme: defaultThemes\" class=custom-themes><div class=template><div class=mini-template ng-style=filterStyle(theme) ng-transclude></div></div><span class=label>{{theme.Name}}</span><div ng-hide=false class=roll-over><button class=\"btn theme-edit-button theme-copy-button\" ng-click=\"\n" +
